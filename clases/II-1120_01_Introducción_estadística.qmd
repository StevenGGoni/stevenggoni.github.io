...
-   Disciplina que **recopila**, **procesa** y **analiza** datos para [realizar conclusiones para la toma de decisiones]{.hi}.
...
-   Recuerde que las variables se pueden clasificar en tipos (la naturaleza del dato) y niveles de medición (qué operaciones matemáticas tienen sentido). Por ejemplo:
    -   La edad es una variable que puede recolectarse como un valor númerico: 25 años o en rangos: 0-10 años, 11-20 años, ...; en el primero caso el nivel de medición es [razón]{.hi} y en el segundo es [ordinal]{.hi}.
