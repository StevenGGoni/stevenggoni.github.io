...
$$
H_0: \mu_1 = \mu_2 = \mu_3 \\
H_1: \text{por lo menos una es diferente}
$$
...
<div style="font-size: 70%; width: 100%; margin: 0 auto;">
...
3.	Exponga sus consideraciones sobre la cantidad de réplicas del diseño. Incluya el efecto que se puede detectar con una potencia del 80 %. Use este [tutorial](https://stevenggoni.github.io/tutoriales_R/potencia_modelos.html){target="_blank"} como apoyo.
