...
```{r venn, out.width="100%", bg="#F1F5F5"}
...
* Se le hace entrega de la base de datos completa, en este [enlace](https://stevenggoni.github.io/clases/data/II-1120_04_Diabetes No Controlada.xlsx), para que practique y repita ejercicios con más volumen de datos.
...
* En la muestra: $P(A)\cdot P(B|A) = \frac{177}{2403} = 0.0736579$
...
* En una fábrica de tornillos, el 80 % de los producidos son de buena calidad, si un tornillo es de buena calidad, tiene una probabilidad del 90 % de ser aprobado en la inspección final. Si es de mala calidad, tiene una probabilidad del 50 %.
