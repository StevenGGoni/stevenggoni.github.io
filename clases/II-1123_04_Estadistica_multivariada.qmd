...
mod1 %>% 
  ...
  broom::tidy() %>% 
  dplyr::mutate(across(where(is.numeric), ~ round(.x, 3))) %>% 
  setNames(c("Término", "gl", "SS", "CM", "F", "P")) %>% 
  knitr::kable(format = "html") %>%
  kableExtra::kable_styling()
...
* Se le hace entrega de los [datos](https://stevenggoni.github.io/clases/data/II-1123_04_Ejercicio integrador.xlsx), así como del ejercicio parcialmente resuelto ([enlace](https://stevenggoni.github.io/clases/data/II-1123_04_Ejercicio integrador resuelto.pdf){target="_blank"}). 
