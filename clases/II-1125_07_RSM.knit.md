...
* El diseño experimental para este modelo debe tener al menos tres niveles para cada variable.
  *>Nota: recuerde que en experimentos factoriales NO se le recomendaba usar más de dos niveles, pues resultan ineficientes. Son las RSM las que pueden resolver problemas que involucren más de dos niveles en variables continuas. 

## Diseño Central Compuesto (DCC) {.bloques}

* Son modelos de segundo orden

* Es un modelo factorial completo $2^k$, compuesto de puntos axiales y centrales. 

* Básicamente, es un factorial completo al que se le ha incrustado una "cruz" con puntos adicionales, la forma de cruz siempre que $k=2$. 
