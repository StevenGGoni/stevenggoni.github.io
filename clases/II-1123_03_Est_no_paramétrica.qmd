...
* Igualmente, recuerde que estos los procedimientos paramétricos son, por lo general, [relativamente insensibles]{.hi} a variaciones pequeñas en la normalidad. 
  * Por lo que, aún de no cumplirse esta condición “*por muy poco*”, aun puede usarlos.
...
* Nótese que no paramétrico no es necesariamente "inferior" ni paramétrico es "mejor" o superior.

## Estadística no parámetrica {.bloques}
...
* Si se puede aplicar una técnica paramétrica, por que se cumplen sus supuestos,  es mejor, pues este generalmente es un método más eficiente: tiene más potencia para un mismo tamaño muestral.  
...
ejemplo_01 <- data.frame(Obsevación = 1:20, 
...
* Por lo que, no hay evidencia suficiente para rechazar la hipótesis nula de que los dos dipositivos de medición son iguales. 
...
* Básicamente es la alternativa a las pruebas de hipótesis sobre dos poblaciones (en paramétrico usamos medias). Lo que evalua es si las distribuciones de ambas poblaciones son iguales. Por lo que podría interpretarse como una prueba sobre la diferencia de las medianas siempre que el supuesto de forma se cumpla.
...
* No son necesariamente pruebas no paramétricas, sino robustas al incumplimiento de la normalidad. 
...
* En Minitab Stat>Basic Statistics>2 Variances...>Options
  * Si el "Use test and confidence intervals based on normal distribution" está marcado, se ejecutará el test F, caso contrario, se ejecta Bonnet y Levene (No paramétricos o robustos a la no normalidad). 

* Resuelva este ejemplo por cuenta propia. Tome en cuenta que por diferencias algoríticas, puede obtener valores distintos en función del software. 
