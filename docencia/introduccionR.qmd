...
Esta guía está basada en este [libro](https://r4ds.hadley.nz/){target="_blank"}.

## Instalación de R y RStudio

-   [\[Última versión de R\]](https://cran.r-project.org/){target="_blank"} en función del sistema operativo

-   [Última versión de RStudio](https://posit.co/download/rstudio-desktop/){target="_blank"}

## Partes de la interfaz de RStudio

![Interfaz de RStudio](img/interfaz.png){fig-align="center"}
...
![](img/paquetes1.png){fig-align="center"}

![](img/paquetes2.png){fig-align="center"}

-   En "Tools\>Install Packages..."

![](img/paquetes3.png){fig-align="center"}
